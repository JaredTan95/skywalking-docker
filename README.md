...
- ```Elasticsearch安装，版本要求5.x：docker run -p 9200:9200 -p 9300:9300 -e cluster.name=sky-es-docker -e xpack.security.enabled=false -e node.name=sky-es-docker-node01 -d docker.elastic.co/elasticsearch/elasticsearch:5.6.10```
